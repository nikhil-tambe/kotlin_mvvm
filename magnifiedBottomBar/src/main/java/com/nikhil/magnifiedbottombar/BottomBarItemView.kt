...
import com.nikhil.magnifiedbottombar.databinding.BottomBarItemViewBinding
...
class BottomBarItemView @JvmOverloads constructor(
    ...
    private val binding = DataBindingUtil.inflate<BottomBarItemViewBinding>(
        LayoutInflater.from(context),
        R.layout.bottom_bar_item_view,
        this,
        true
    )
