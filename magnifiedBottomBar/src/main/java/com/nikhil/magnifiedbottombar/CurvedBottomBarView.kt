...
class CurvedBottomBarView @JvmOverloads constructor(
    ...
    init {
        ...
        mainPaint?.apply {
            ...
            color = this@CurvedBottomBarView.color
        }
    ...
    private fun calculateInner() {
        ...
        innerArray[3] = PointF(bezierX - bezierInnerWidth / 4,  extra)
        innerArray[4] = PointF(bezierX, extra)
        innerArray[5] = PointF(bezierX + bezierInnerWidth / 4,  extra)
